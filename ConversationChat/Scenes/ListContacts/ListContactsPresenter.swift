...
class ListContactsPresenter: ListContactsPresentationLogic
{
  ...
  func presentContacts(response: ListContacts.FetchContacts.Response)
  {
    ...
    {
        let displayedContacts = ListContacts.FetchContacts.ViewModel.DisplayedContact(id: contact.id, name: contact.name, lastname: contact.lastname, fullname: contact.fullname, initials: contact.initials, phoneNumber: contact.phoneNumber, avatarUrl: contact.avatarUrl, description: "description")
