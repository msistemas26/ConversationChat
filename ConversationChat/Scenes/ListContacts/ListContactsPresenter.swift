...
class ListContactsPresenter: ListContactsPresentationLogic
{
  ...
  func presentContacts(response: ListContacts.FetchContacts.Response)
  {
    ...
    {
        let displayedContacts = ListContacts.FetchContacts.ViewModel.DisplayedContact(id: contact.id, name: contact.name, lastname: contact.lastname, phoneNumber: contact.phoneNumber, avatarUrl: contact.avatarUrl)
